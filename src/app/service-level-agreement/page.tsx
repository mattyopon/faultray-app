...
export default function SlaDocPage() {
  return (
    <div className="max-w-[860px] mx-auto px-6 py-20">
      ...
      <p className="text-sm text-[var(--text-muted)] mb-2">Version 1.0 — Effective: April 1, 2026</p>
      <p className="text-sm text-[var(--text-muted)] mb-12">Applies to: FaultRay Pro and Business plans</p>
      ...
      <div className="prose-custom space-y-10 text-[var(--text-secondary)] leading-relaxed">
        ...
        <section>
          ...
          <div className="overflow-x-auto rounded-xl border border-[var(--border-color)] mb-4">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-[var(--border-color)] bg-[#141a2e]">
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Plan</th>
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Uptime Guarantee</th>
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Max Monthly Downtime</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={row.plan} className="border-b border-[var(--border-color)] last:border-0">
                    <td className="px-5 py-3 font-semibold text-white bg-[var(--bg-card)]">{row.plan}</td>
                    <td className="px-5 py-3 bg-[var(--bg-card)] text-emerald-400 font-bold">{row.uptime}</td>
                    <td className="px-5 py-3 bg-[var(--bg-card)] font-mono text-xs">{row.downtime}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <p className="text-sm">
            ...
            <Link href="/status" className="text-[var(--gold)] hover:underline">
              status.faultray.com
            </Link>
            ) are excluded.
          </p>
        ...
        <section>
          ...
          <div className="overflow-x-auto rounded-xl border border-[var(--border-color)] mb-4">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-[var(--border-color)] bg-[#141a2e]">
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Monthly Uptime</th>
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Service Credit</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={row.uptime} className="border-b border-[var(--border-color)] last:border-0">
                    <td className="px-5 py-3 font-mono text-white bg-[var(--bg-card)]">{row.uptime}</td>
                    <td className="px-5 py-3 text-[var(--gold)] font-semibold bg-[var(--bg-card)]">{row.credit}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <p className="text-sm">
            ...
            <a href="mailto:support@faultray.com" className="text-[var(--gold)] hover:underline">
          ...
          <div className="overflow-x-auto rounded-xl border border-[var(--border-color)] mb-4">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-[var(--border-color)] bg-[#141a2e]">
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Plan</th>
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">Channel</th>
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">P1 Response</th>
                  <th scope="col" className="px-5 py-3 text-left text-[var(--text-secondary)] font-semibold">P2–P3 Response</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={row.plan} className="border-b border-[var(--border-color)] last:border-0">
                    <td className="px-5 py-3 font-semibold text-white bg-[var(--bg-card)]">{row.plan}</td>
                    <td className="px-5 py-3 bg-[var(--bg-card)]">{row.channel}</td>
                    <td className="px-5 py-3 text-emerald-400 font-mono text-xs bg-[var(--bg-card)]">{row.p1}</td>
                    <td className="px-5 py-3 text-blue-400 font-mono text-xs bg-[var(--bg-card)]">{row.p23}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.title} className="p-4 rounded-xl border border-[var(--border-color)] bg-[var(--bg-card)]">
        ...
        <section>
          ...
          <div className="p-5 rounded-xl border border-[var(--border-color)] bg-[var(--bg-card)] space-y-2 text-sm">
            <p>
            ...
            <p>
              ...
              <Link href="/dpa" className="text-[var(--gold)] hover:underline">
                faultray.com/dpa
              </Link>
            </p>
          </div>
