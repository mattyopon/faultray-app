    ...
    <div className="max-w-[1200px] mx-auto px-6 py-10">
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <p className="text-[#94a3b8] text-sm">View and analyze simulation results</p>
        </div>
      ...
      {loading ? (
        <div className="text-center py-20 text-[#64748b]">Loading results...</div>
      ) : filteredRuns.length === 0 ? (
        <Card className="text-center py-16">
          <FileText size={48} className="text-[#1e293b] mx-auto mb-4" />
          <p className="text-[#64748b] mb-2">No results found</p>
          <p className="text-xs text-[#64748b]">Run a simulation to see results here</p>
        </Card>
      ) : (
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                  <div className="text-center min-w-[80px]">
                    ...
                    <p className="text-[10px] text-[#64748b] uppercase tracking-wider">Score</p>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    ...
                    <p className="text-xs text-[#64748b]">scenarios passed</p>
                  </div>
